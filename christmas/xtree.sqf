...
if (isServer) then {
    ...
    [
    	...
    	["ASC_EU_BulbBLUB", [_kordX + 2.969, _kordY - 2.394, _kordH + 0.8863241], -18.422382],	// 10
    	...
    	["ASC_EU_BulbBLUB", [_kordX - 3.408, _kordY + 0.926, _kordH + 2.8890289], -18.422382],	//19
    	...
    	["ASC_EU_BulbGRNB", [_kordX + 1.291, _kordY - 0.445, _kordH + 8.1424328], -18.422382],	//33
    	...
    	["ASC_EU_BulbPURB", [_kordX - 0.089, _kordY - 2.33, _kordH + 2.0356511], -18.422382],	//43
